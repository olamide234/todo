...
export default class Todo extends Component {
    ...
    render() {
        ...
        if(this.state.isEditing) {
            ...
            result = (
                <div className="todo__oneTodo">
                    <div className={"todo__oneTodo-main"} 
                     onClick={this.handleToggleCompletion}
                    >
                        <button className={this.state.isCompleted ? "todo__oneTodo-main__toggleBtn completed" : "todo__oneTodo-main__toggleBtn"}>
                    ...
                    <div className="todo__oneTodo-functions">
                        ...
                        <MdDelete className="todo__oneTodo-functions__delete" onClick={this.handleRemove} color="hsl(233, 14%, 35%)" size={25}/>
                    </div>
                </div>
            )
        }
